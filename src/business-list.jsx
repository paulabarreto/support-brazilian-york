  ...
  constructor(props) {
    ...
    this.state = 
      [
        ...
        {image: "docs/delicake.png", title: "Delicake", text: "Cakes and sweets", website: "https://delicake.ca/"},
      ];
  }
    ...
    return (
      <div className="row">
        {this.state.map((business, index) => (
          <div key={index} className="col-sm mb-3 d-flex justify-content-center">
            <div className="card" style={{width: 18 + 'rem'}}>
                ...
                <div className="card-body">
                  ...
                  <a href="#"><i className="p-2 fab fa-facebook"></i></a>
